...
import fetchAudioFeatures, { fetchAlbum, fetchAlbumTracks, fetchArtist, fetchPlaylistTracks, fetchPlaylists, fetchSongInfo, fetchTracks, getAccessToken } from '../src/script';
...
it("fetchTracks", async () => {
  ...
  expect(trackInfo.album.images[0].url).toMatchInlineSnapshot('"https://i.scdn.co/image/ab67616d0000b273ab497e0fae9d1c8ef2e7a165"'); 
});